...
func BenchmarkConcatStringWithPreallocate(b *testing.B) {
	var str = "abcdefghijklmnopqrstuvwxyz"
	for n := 0; n < b.N; n++ {
		ConcatWithPreallocate(str, str, str, str, str, str, str, str, str, str)
	}
}

func BenchmarkConcatStringWithPlus(b *testing.B) {
	var str = "abcdefghijklmnopqrstuvwxyz"
	for n := 0; n < b.N; n++ {
		ConcatWithPlus(str, str, str, str, str, str, str, str, str, str)
	}
}
...
func BenchmarkConcatStringWithBuilder(b *testing.B) {
	var str = "abcdefghijklmnopqrstuvwxyz"
	for n := 0; n < b.N; n++ {
		ConcatWithBuilder(str, str, str, str, str, str, str, str, str, str)
	}
}
